...
const STACKS: Record<string, StackData> = {
  fire: {
    ...
    burgerImage: "/Stacks/Fire.webp",
    sideImage: "/Fries/chillicheesefries.webp",
    color: "#EF4444",
  ...
  melt: {
    ...
    burgerImage: "/Stacks/Melt.webp",
    sideImage: "/Fries/Fullstackdfries.webp",
    color: "#F97316",
