...
const MENU_CATEGORIES = [
  ...
  },
  {
    id: 'appetizers',
    label: 'Appetizers',
    description: 'Crispy sides & meal bites',
    emoji: '🍗',
  ...
  },
  {
    id: 'dips',
    label: 'Dips & Sauces',
    description: 'Handcrafted dipping sauces',
    emoji: '🥣',
    href: '/menu/dips',
    accent: '#EF4444',
    items: ['Thousand Island', 'Chipotle', 'Honey Mustard', 'Mustard', 'Nachos Cheese Sauce', 'Buffalo', 'BBQ'],
  },
  {
    id: 'drinks',
    label: 'Drinks',
